...
📂 Featured Projects
ProjectDescriptionWrite-upsplunk-soc-labHome SOC lab — 700k+ real log events, MITRE-mapped detection rule, incident triageMediumathena-pentestFull-scope pentest — SMB enumeration, command injection, privilege escalation to rootMediumms17-010-vulnerability-case-studyVulnerability management case study — EternalBlue/MS17-010 on Windows 7Mediumpihole-wireguard-labRaspberry Pi DNS sinkhole + WireGuard VPN for network privacy and secure remote access—
